...
export default function Home() {
  const serviceDetails = {
    ...
    faqs: [
      ...
      { question: 'Can you register wills within the DIFC Wills and Probate Registry?', answer: 'Yes. Adv. Bindu S. Chettur is one of the very few and longest-serving Indian lawyers registered as a Will Draftsman with the DIFC Wills and Probate Registry. Our team is fully equipped to assist with the drafting, registration, and administration of DIFC Wills, providing comprehensive guidance throughout the entire process to ensure your estate planning needs are met with precision and care.' },
    ],
  };
