...
export default function About() {
    ...
    const [aboutContent, setAboutContent] = useState({
        ...
        aboutText:
            "As a highly skilled and experienced lawyer, I am dedicated to providing exceptional legal services to my clients. With a deep understanding of the legal system and a commitment to delivering results across UAE and India.",
        learnMoreLink: "/about",
        ...
        counters: [
            { icon: "icon-icon-13", count: 32, suffix: "+", title: "Years of Service" },
            { icon: "icon-icon-14", count: 5, suffix: "k+", title: "Satisfied Clients" },
