  ...
  const [cases, setCases] = useState([
    {
      ...
      subTitleText: "press & media coverage",
      title: "featured in leading publications worldwide",
      imgSrc: "/assets/img/project/case-v1-img1.jpg",
      category: "Gulf News",
      caseTitle: "Indebted widow of organ donor returns to India",
    ...
    },
    {
      ...
      caseTitle: "17 Indians in Sharjah death row to walk free soon",
      caseLink: "/case-details",
    },
    {
      delay: ".3s",
      imgSrc: "/assets/img/project/case-v1-img3.jpg",
      category: "The National News UAE",
      caseTitle: "Dh1.5m compensation case against 17 Indian men",
      caseLink: "/case-details",
      buttonText: "view all",
      buttonLink: "/case",
    },
    {
      ...
      category: "Economist Dubai",
      caseTitle: "Dubai encourages Entrepreneurs, says Adv. Bindu S. Chettur",
      caseLink: "/case-details",
    },
  ]);
