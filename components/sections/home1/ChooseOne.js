...
export default function ChooseOne() {
  ...
  const [chooseContent, setChooseContent] = useState({
    ...
    sectionMainTitle: "trusted legal counsel across borders",
    chooseText:
      "With expertise spanning mainland UAE law, DIFC and ADGM Courts, we deliver comprehensive legal solutions for individuals and businesses operating across India and the UAE.",
    features: [
      "32+ years of cross-border legal expertise",
      "Audience rights in DIFC and ADGM Courts",
    ],
